...
$(document).ready(function() {
	...
	var table = $('.targetTable').DataTable({
		...
		"oLanguage": {
			...
			"sInfo": "_START_ to _END_ of total _TOTAL_ records displayed",
			"sInfoEmpty": "Showing 0 to 0 out of 0 records",
			"sInfoFiltered": "(filtered by all _MAX_ records)",
			"sInfoPostFix": "",
			"sSearch": "Search all columns (click on the title link to see all data):",
			"buttons": {
